...
// code here
document.querySelector('#cretedBy').innerHTML('John')
/* 
...
function buildToDo(todo, index) {
  ...
  if (todo.complete) {
    return toDoText.classList.add('completeText')
  }
  
  toDoText.appendChild(todDoShell)
  return toDoShell
}
...
function buildToDos(toDos) {
  // code here
  document.getElementById('toDoText').addEventListener('click', completeToDo);
